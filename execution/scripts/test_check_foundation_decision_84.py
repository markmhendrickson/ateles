...
CORPUS = {
    ...
    "scenarios.md": "Every task has its intake batch at creation; an assembling task is the ruled exception only in carrying a persistent assembly exclusion, and only the resolved `pm` step owner claims.\n",
