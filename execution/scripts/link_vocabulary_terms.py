...
`coverage`, `delivery`, `event`, `grant`, `approval`, `initiative`, `mapping`, `record`, `subject`, and the
two verb entries `execute (a task)` and `take (an action)`. Linking their first occurrence mislabels the ordinary use:
