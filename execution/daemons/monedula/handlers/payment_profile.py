...
Each profile is identified by a PREFIX (e.g. "THERAPY", "YOGA") and reads:
  ...
  <PREFIX>_CONTACT_ID     (wise only) Neotoma contact entity id (ent_...) —
                          preferred — or legacy contacts.parquet contact_id
                          prefix used only when Neotoma resolution yields
                          nothing.
