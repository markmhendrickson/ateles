...
Runs as a launchd agent — see com.markmhendrickson.piculet.plist.
"""
...
# Load Neotoma env vars (bearer token, data dir, etc.) from the standard
# ~/.config/neotoma/.env file, which launchd does not source automatically.
