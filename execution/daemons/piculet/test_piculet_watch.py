"""
Startup-config tests for piculet/watch.py — ateles#243.

Mirrors execution/daemons/cyphorhinus/test_watch.py: watch.py already fails
loud on runtime connection failures via NeotomaUnavailableError; the only
defect this issue fixes here is the hardcoded :3180 default for
_NEOTOMA_BASE_URL.

Run with: pytest execution/daemons/piculet/test_watch.py -v
"""
