...
`execution/scripts/render_rule_inventory.py`, `foundation/status.md`, the dated implementation-gap
measurement, and `foundation/skill_inventory.md`, the dated skill-corpus measurement (stage 0 for the
skills migration). `foundation/projection/` is generated by
