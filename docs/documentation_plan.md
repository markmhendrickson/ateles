...
dated skill-corpus measurement (stage 0 for the skills migration), and `foundation/rule_inventory.md`, the
dated rule-corpus measurement (stage 0 for the rule migration). `foundation/projection/` is generated by
