...
every place a rule is stated across the harnesses and stores, generated by
`execution/scripts/render_rule_inventory.py`. `foundation/projection/` is generated by
