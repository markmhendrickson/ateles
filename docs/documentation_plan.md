...
`foundation/*` (25 authored documents: a 3-document always-read kernel; 14 path-keyed documents, five of
...
`planning_model.md`, and one the tenancy boundary, `multi_tenant.md`; and 8
...
`foundation/status.md`, the dated implementation-gap measurement, and `foundation/skill_inventory.md`, the
dated skill-corpus measurement (stage 0 for the skills migration). `foundation/projection/` is generated by
