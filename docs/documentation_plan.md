...
companions — `scenarios.md`, `workflows.md`, `migration.md`, `revisions.md`, and `foundation/status.md`, the dated
implementation-gap measurement. `foundation/projection/` is generated by
