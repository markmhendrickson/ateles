...
`foundation/*` (23 authored documents: a 3-document always-read kernel; 14 path-keyed documents, five of
...
`planning_model.md`, and one the tenancy boundary, `multi_tenant.md`; and 6
