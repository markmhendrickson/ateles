...
they were: 33 and 34 are the condensation pass's, and 55 — whether a second instance of the record is an external
...
**The register after this revision.** Open rows: 33, 34 (both deferred to the condensation pass), and 55. Ruled:
...
home for the grouping instead of two. The prose's own wording is left to the condensation pass, not decided
