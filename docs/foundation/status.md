...
deliberately not in the reading list (`conformance.md`): the review lenses never receive it, and no
foundation document cites it. Read the as-of line before trusting anything below.
