...
rather than their number, as 13 and 14 are. Ten rows are open — 31; 36, opened on the operator's 2026-09-05 memos on how tasks come into existence and
...
each argued under a heading naming its subject in the document that owns it; and 42, opened by the skills leg of the migration; and 43 and 44, which the conformance-suite design opened from the two places a from-zero run found no rule to test; and 45, opened by the workflow-format pass from what ten real declarations could not say, and argued in `adapters.md`; 37 to 41 were opened and ruled
