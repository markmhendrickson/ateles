...
now, while the evidence is gathered, rather than left to be re-derived later. 72 has since been ruled — the
verdict-rename pass of 2026-09-08 executed it — and 73 stands as this paragraph left it. **Which rows are
