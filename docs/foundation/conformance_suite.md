...
one, U-14, is now open decision 56. Each closed row keeps its
...
| GW-33 | `gates_and_workflows.md#two-questions-who-may-claim-a-step-and-whether-an-action-may-be-taken`: governance writes are actions | as WM-22 | — | as WM-22 | M for admission; P for the permitted-action half (open decision 56) |
| GW-33a | `gates_and_workflows.md#where-the-enforcement-point-for-a-governance-write-sits` | as WM-22 | — | — | P (open decision 56; under the first option the record refuses the write, under the second the proxy does, under the third the grant check does — WM-22, GW-29, GW-33, WM-40b, AD-27, and MG-4 are the rows a ruling turns from audit to refusal) |
