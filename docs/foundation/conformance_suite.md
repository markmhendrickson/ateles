...
| WF-2 | `workflows.md#roles-named-in-this-document`: every role resolves against the roster per declaration scope | `B0` | declare each | any role resolving to nobody without a checkpoint | M |
