...
| Statements of those rules, across all stores | **545** |
| **Duplication factor** | **10.5×** |
| Clusters whose statements DIVERGE on binding force | **15** |
| Normative statements scanned in total | 4455 |
| …of those, matching no known rule kind | 3978 |
| Statement values withheld from public output | 4455 |
...
The factor is computed over the 545 statements that match a known rule kind, not over all 4455 scanned. The remainder are procedure, context, or rules whose kind has no signature yet — counting them would inflate the figure with statements the migration has nothing to collapse.
...
| ateles/CLAUDE.md | `CLAUDE.md` | 1 | 85 | 2026-09-23 | yes |
| standing_rule entities | `<entity>` | 52 | 73 | 2026-09-22 | sidecar only |
| Codex | `~/.codex/AGENTS.md` | 1 | 67 | 2026-09-14 | yes |
| Claude Code hooks (ateles) | `.claude/hooks` | 22 | 58 | 2026-09-23 | yes |
...
| ateles/CLAUDE.md checkout copies | `~/repos/<checkout>` | 143 | 0 | 2026-09-23 | divergent |
...
| `R-228b8c` Absent or malformed safety values take the restrictive branch | 18 | advisory, mandatory, prohibitive/binding | Claude Code hooks (ateles), Claude Code project memory, Codex, Skills (ateles repo), Skills (user root), ateles/CLAUDE.md, neotoma/AGENTS.md |
...
| `R-228b8c` | Absent or malformed safety values take the restrictive branch | 18 | 14 | 7 | DIVERGE | docs/foundation/ |
...
| ateles/CLAUDE.md | `CLAUDE.md` | L171 |
| standing_rule entities | `<entity>` | instruction |
| standing_rule entities | `<entity>` | instruction |
...
| ateles/CLAUDE.md | `CLAUDE.md` | L221 |
| standing_rule entities | `<entity>` | rule |
...
Target home: **docs/foundation/** · 18 statements, 14 distinct · **DIVERGE**
...
| ateles/CLAUDE.md | `CLAUDE.md` | L210 |
...
| ateles/CLAUDE.md | `CLAUDE.md` | L212 |
...
| ateles/CLAUDE.md | `CLAUDE.md` | L180 |
| ateles/CLAUDE.md | `CLAUDE.md` | L286 |
...
|---|---|---|
| Claude Code project memory | `~/.claude/projects/<project>/memory/<file>` | L30 |
| ateles/CLAUDE.md | `CLAUDE.md` | L190 |
