...
**Kind:** foundation companion; generated, never authored. **Generated by:** `execution/scripts/render_rule_inventory.py`, held equal to the measured system by `--check`. **Measured:** 2026-09-24.
...
|---|---|---|---|---|---|
| Skills (ateles repo) | `.claude/skills/<skill>` | 96 | 1377 | 2026-09-24 | yes |
...
| ateles/CLAUDE.md | `CLAUDE.md` | 1 | 84 | 2026-09-24 | yes |
| standing_rule entities | `<entity>` | 52 | 73 | 2026-09-22 | sidecar only |
| Codex | `~/.codex/AGENTS.md` | 1 | 67 | 2026-09-14 | yes |
| Claude Code hooks (ateles) | `.claude/hooks` | 20 | 52 | 2026-09-24 | yes |
