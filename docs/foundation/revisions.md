...
| 57 | the underdetermined-inputs pass of 2026-09-06 | the [`underdetermined_inputs`](#underdetermined_inputs) entry added, swap-tested against `undetermined_scope` and `undeclared_dependency` |
