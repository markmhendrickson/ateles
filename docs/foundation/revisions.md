...
branch cannot see. As of 2026-09-07 that sweep over every open pull-request branch gives 76 (PR #794), so the next
free number is 77, which this pass takes. The number this file carried before that sweep was 71, established
by an earlier sweep the same day whose maximum was 70 (PR #784); five further numbers were assigned on other
branches between the two sweeps, which is the recurrence the standing instruction above exists for.
...
| 77 | the decision-78 ruling of 2026-09-07 | decision 78 moved from open to ruled, argued in `adapters.md`; the row names the two dispositions the operator's answer eliminated and why record-elsewhere-and-reconcile lost to extending 45 on his "within governance" qualifier |
