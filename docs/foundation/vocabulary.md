...
not what a [verdict](#verdict) references).
...
**What ruling this cost.** 942 sites carrying the retired spellings: 901 hyphenated, of which 70 plural, and 41
underscored as the field; 44 of the hyphenated ones are anchors. The 13 uses of the verb
phrase are not sites: they stay. Four headings changed anchors, and every citation of
