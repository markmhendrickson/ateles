...
cited as [proposal](#proposal)), `multi_tenant.md` section 5, PR #745 operator review (2026-09-04),
...
follows Neotoma's `docs/vocabulary/canonical_terms.md`. Amendment history: `revisions.md#vocabularymd`.
