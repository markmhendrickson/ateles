...
Amendment history: `revisions.md#vocabularymd`.
## Purpose
...
- **Ruled (decision 72, 2026-09-07, on the operator's 2026-09-06 memo).**
- **The record is neutral; the old name was not.**
- **The tell was that `signed` was one of the retired `sign-off`'s own conclusion values.**
