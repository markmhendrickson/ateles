...
**Related:** `/shared/docs/agent-persistence-requirements.md` for contact and email persistence requirements.
...
**Reference:** `/shared/docs/agent-persistence-requirements.md` for complete contact persistence requirements.
