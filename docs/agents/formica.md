...
*Canonical agent file, generated from Neotoma `agent_definition` `ent_d62f1df8784b7f4fcadc7d74`. Harness-neutral — the Claude Code mirror at `.claude/skills/formica/SKILL.md` is generated from this same entity. Do not edit directly: correct the entity and run `python3 execution/scripts/render_agent_docs.py`.*
