...
Public-facing personal representative at the operator's public agent endpoint. Read-only, public_read AAuth scope — can only access visibility=public entities. Lyrebird genus (mimics the operator's public voice).
