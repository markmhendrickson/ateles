...
# "never scored" from "scored low", and fail-closed behavior must be
...
def test_confidence_unscored_defaults_false_for_existing_callers():
    ...
    default to False so none of them silently start reporting "never scored"
