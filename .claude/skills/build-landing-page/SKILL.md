...
description: "Build or rebuild a product landing page or multi-page product site through explicit, durable stages: template and page inventory, CTA and content specification, current best-practice and competitor research, input/design inventory, then a verified repository-generated site preview. Consumes the ambition-first argument from /frame-product-argument and settled category rather than re-deriving them. Use for a product homepage, landing page, or product site; not for one-recipient rendered pages, repository scaffolding, deployment, or release."
...
generator. Read the generator's current interface and checks from the repository;
