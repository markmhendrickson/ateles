...
## Worked example
Elefun Yoga — contact: a yoga teacher; preview: rendered_page "Manual de Asistencias" (ent_74102735c6a5df2d9ef88b3c); graph: pose/pose_category/assist/assist_method/sequence/manual under a "5+2" classification, built from voice notes + emailed PDFs/videos, shared via guest link.
